...
public class MotionAnalyze : MonoBehaviour
{
    private NaturalLanguageUnderstandingService service;
    private string apikey = "Qr6kaaQSTfsSF7depBJHogQtxYPbNQmfouCD-BE1_yEc";   // Start is called before the first frame update
    private string url = "https://gateway.watsonplatform.net/natural-language-understanding/api";
    void Start()
    {
    ...
    private IEnumerator CreateService() {
        ...
        while (!credentials.HasIamTokenData())
            yield return null;
        service = new NaturalLanguageUnderstandingService("2019-07-14",credentials);

    }

    public void getEmotions(string text) {
        ...
        service.Analyze(OnSuccess, features, text);
        //    categories: { },
        //    concepts: { },
        //    emotion: { },
        //    entities: { },
    ...
    private void OnSuccess(DetailedResponse<AnalysisResults> response, IBMError error)
    {
        Debug.Log(response.Result.Emotion.Document.Emotion.Joy);
